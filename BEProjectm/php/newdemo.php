...
<div id="wrapper">
	...
	<div id="menu">
			<ul>
				...
				<li><a href="#" accesskey="2" title="">Addfriend</a></li><br>
				<li><a href="#" accesskey="3" title="">View Friend</a></li><br>
				<li><a href="#" accesskey="4" title="">Logout</a></li><br>
	...
	<div id="page">
		<div id="content">
			...
			<h3>google map</h3>
<div id="googleMap" style="width: 400px;height: 300px;">
...
$redirect_uri="http://localhost/BEProjectm/php/newdemo.php";
